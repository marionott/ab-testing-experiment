...
import OptimizeLayout from '../components/OptimizeLayout'
    ...
    <OptimizeLayout>
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          ...
          <Text className='mb-4'>
            The about and marketing pages will render the version of the page
          ...
          <Text className='mb-4'>
            Click the button below if you want to change the current variant
            (each variant has a 33% chance)
          </Text>
